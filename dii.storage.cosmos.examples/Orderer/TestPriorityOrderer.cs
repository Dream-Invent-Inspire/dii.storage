...
namespace dii.storage.cosmos.examples.Orderer
{
    public class TestPriorityOrderer : ITestCaseOrderer
    {
        public const string FullName = "dii.storage.cosmos.examples.Orderer.TestPriorityOrderer";
        public const string AssemblyName = "dii.storage.cosmos.examples";
