...
namespace dii.cosmos.tests
{
  ...
  ""_ts"": 1654531583
        ...
        public void PackageToJson_Success()
        {
            ...
            Assert.NotNull(entity);
            Assert.Equal($"{{\"id\":\"{fakeEntityTwo.Id}\",\"string\":null,\"_etag\":null,\"p\":\"kdkkZmFrZUVudGl0eVR3bzogQ29tcHJlc3NlZFN0cmluZ1ZhbHVl\",\"PK\":\"{fakeEntityTwo.FakeEntityTwoId}\"}}", entity);
        }
