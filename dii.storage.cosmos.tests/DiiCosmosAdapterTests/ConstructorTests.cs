...
{
    [Collection(nameof(ConstructorTests))]
    ...
    public class ConstructorTests
    {
        ...
        {
            var exception = Assert.Throws<ArgumentNullException>(() => { new FakeEntityAdapter(databaseId); });
        ...
        public void ConstructorTests_NullDatabaseIdConfig(string[] databaseIds)
        {
            ...
            var exception = Assert.Throws<DiiDatabaseIdNotInConfigurationException>(() => { new FakeEntityAdapter("databaseId"); });
