...
namespace dii.storage.cosmos.tests.Orderer
{
    public class TestCollectionPriorityOrderer : ITestCollectionOrderer
    {
        public const string FullName = "dii.storage.cosmos.tests.Orderer.TestCollectionPriorityOrderer";
        public const string AssemblyName = "dii.storage.cosmos.tests";
